...
export const INITIAL_JOB_DATABASE: JobPosting[] = [
  {
    "id": "job-sec-1",
    ...
    "benefits": [
      "Top-of-market equity stock options",
      "Full family health insurance + wellness stipend"
    ],
  ...
  },
  {
    ...
    "benefits": [
      ...
      "\u20b91,00,000 annual learning stipend"
    ],
  ...
  },
  {
    ...
    "benefits": [
      "Work-from-anywhere policy 1 month/year",
  ...
  },
  {
    ...
    "benefits": [
      "Relocation allowance to Chennai/Bengaluru",
  ...
  },
  {
    ...
    "benefits": [
      "100% Remote within India",
      "Internet & home ergonomic setup allowance"
    ],
  ...
  },
  {
    ...
    "benefits": [
      "Field trip stipends across India",
  ...
  },
  {
    ...
    "benefits": [
      "High-value food credits & Swiggy One membership",
      "Generous ESOP grants"
    ],
    "postedDate": "1 day ago",
    "applicantsCount": 45,
    "featured": true
  ...
  },
  {
    ...
    "benefits": [
      "Comprehensive medical coverage for entire family",
  ...
  },
  {
    ...
    "benefits": [
      "Flipkart employee discounts",
      "Comprehensive insurance + wellness funds"
    ],
    "postedDate": "2 days ago",
    "applicantsCount": 54,
    "featured": false
  ...
  },
  {
    ...
    "benefits": [
      "Free high-speed JioFiber & 5G services",
      "Corporate transport bus service"
    ],
    "postedDate": "4 days ago",
    "applicantsCount": 68,
    "featured": false
  },
  {
    ...
    "benefits": [
      "Full UK/US Visa Sponsorship and relocation package",
  ...
  },
  {
    ...
    "benefits": [
      "Top tier Silicon Valley compensation",
      "Relocation + H1B/O-1 visa sponsorship"
    ],
    "postedDate": "2 days ago",
    "applicantsCount": 62,
    "featured": true
  ...
  },
  {
    ...
    "benefits": [
      "Relocation grant to Switzerland or USA",
      "Generous annual ESPP grants"
    ],
    "postedDate": "1 day ago",
    "applicantsCount": 51,
    "featured": true
  },
  {
    ...
    "benefits": [
      "Top global hedge fund discretionary performance bonus",
      "Full relocation and housing stipend"
    ],
    "postedDate": "2 days ago",
    "applicantsCount": 93,
    "featured": true
  },
  {
    ...
    "benefits": [
      ...
      "Comprehensive European or US relocation package"
    ],
    "postedDate": "3 days ago",
    "applicantsCount": 47,
    "featured": false
  },
  {
    ...
    "benefits": [
      "100% Remote flexibility anywhere in US/Europe",
      "Home office & GPU workstation budget"
    ],
    "postedDate": "4 days ago",
    "applicantsCount": 65,
    "featured": false
  },
  {
    ...
    "benefits": [
      "Full UK/US visa sponsorship",
      "Comprehensive scientific sabbatical program"
    ],
    "postedDate": "2 days ago",
    "applicantsCount": 33,
    "featured": true
  },
  {
    ...
    "benefits": [
      "UK/Singapore Tier-2 visa sponsorship",
      "Private healthcare + pension matching"
    ],
    "postedDate": "3 days ago",
    "applicantsCount": 29,
    "featured": false
  },
  {
    ...
    "benefits": [
      "100% Tax-Free UAE Compensation",
      "Luxury accommodation stipend + flights home"
    ],
    "postedDate": "1 day ago",
    "applicantsCount": 71,
    "featured": true
  },
  {
    ...
    "benefits": [
      "Waymo ride discounts",
      "Full US H1B/Greencard sponsorship"
    ],
    "postedDate": "2 days ago",
    "applicantsCount": 58,
    "featured": false
  },
  {
    ...
    "benefits": [
      "Relocation assistance to Switzerland or USA",
      "Patent award incentive bonuses"
    ],
    "postedDate": "3 days ago",
    "applicantsCount": 26,
    "featured": false
  },
  {
    ...
    "benefits": [
      "Microsoft hardware discounts",
      "Comprehensive Canada/US relocation"
    ],
    "postedDate": "2 days ago",
    "applicantsCount": 73,
    "featured": false
  },
  {
    ...
    "benefits": [
      "100% remote flexibility with global co-working pass",
  ...
  },
  {
    ...
    "benefits": [
      "Top tier pre-IPO stock options",
      "Unlimited home office tech allowance"
    ],
    "postedDate": "3 days ago",
    "applicantsCount": 31,
    "featured": false
...
export function calculateResumeMatchScore(
  ...
  jobSkills.forEach((skill) => {
    ...
    if (candidateLower.some((c) => c.includes(sLower) || sLower.includes(c))) {
  ...
  const expMatchRatio = Math.min(1.0, (candidateExpYears + 0.5) / Math.max(1, job.minExperienceYears || 1));

  const totalScore = Math.round(skillMatchRatio * 70 + expMatchRatio * 30);
  const clampedScore = Math.max(45, Math.min(99, totalScore));

  return {
    matchScore: clampedScore,
    matchingSkills,
    missingSkills,
    isRecommended: clampedScore >= 70,
  };
}
...
export const calculateMatchScore = (
  ...
  return calculateResumeMatchScore(
    { techStack: jobTechStack, minExperienceYears: minExp } as any,
    candidateSkills,
    candidateExp
  ).matchScore;
};
...
// Fetch all jobs
export async function getAllJobPostings(filter?: {
  search?: string;
...
export async function applyForJob(
  jobIdOrData: string | Omit<JobApplication, 'id' | 'status' | 'appliedAt'>,
  optionalData?: Omit<JobApplication, 'id' | 'status' | 'appliedAt'>
): Promise<{ success: boolean; application?: JobApplication; error?: string }> {
  let jobId: string;
  let applicationData: Omit<JobApplication, 'id' | 'status' | 'appliedAt'>;

  if (typeof jobIdOrData === 'string') {
    jobId = jobIdOrData;
    applicationData = optionalData!;
  } else {
    jobId = jobIdOrData.jobId;
    applicationData = jobIdOrData;
  }
...
export const submitJobApplication = applyForJob;
...
export const getCandidateApplications = getUserApplications;
